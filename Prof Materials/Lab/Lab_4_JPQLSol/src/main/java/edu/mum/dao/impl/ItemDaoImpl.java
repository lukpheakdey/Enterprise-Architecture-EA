...
public class ItemDaoImpl extends GenericDaoImpl<Item> implements ItemDao {
	...
	public List<Item> findBySellerOrBuyer(Integer initialPrice, User buyer, User seller) {
		...
		if (buyer != null)	buyerPrice=  "( u = :buyer and i member of u.boughtItems and  i.initialPrice = i.reservePrice  )";
		...
		if (seller != null) query.setParameter("seller", seller).setParameter("price", price);
		if (buyer != null)  query.setParameter("buyer", buyer );
...
/*		Query query = entityManager.createQuery("select i from Item i, Category c where c.name = :categoryName and i MEMBER OF c.items");*/
